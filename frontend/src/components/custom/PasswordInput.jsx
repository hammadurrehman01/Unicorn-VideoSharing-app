...
const PasswordInput = ({ value, onchange }) => {
    ...
    return (
        <Stack direction={"row"} sx={{ backgroundColor: "#F2F2F2", width: "100%", marginLeft: "auto", alignItems: "center", pr: "8px", mt: "0.5rem", borderRadius: "0.5rem" }}>
            <Input value={value} type={isVisible ? "password" : "text"} disableUnderline={true} onChange={onchange } placeholder="Enter your password" sx={{ py: "6px", px: "16px", borderRadius: "0.5rem", width: "98%" }}></Input>
